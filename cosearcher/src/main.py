...
if __name__ == "__main__":
    ...
    parser.add_argument("--candidate_column_name", type=str, default= 'candidate')
    ...
    yes_no_detector = yes_no_detection.AlwaysYesYesNoDetector()
    #answer_generator = answer_generation.QulacAnswerGenerator(
    #    yes_no_detector, perfect_match_threshold=args.threshold_user
    #)

    answer_generator = answer_generation.LookUpGenerator(
        output_file_path = args.output_file_path,
        candidate_column_name = args.candidate_column_name
    )
    ...
    question_generator = question_generation.LookUpQuestionGenerator()
